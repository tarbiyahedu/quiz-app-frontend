  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold text-[#0E2647]">Admin Profile</h1>
          <p className="text-gray-600 mt-2">Manage your admin account information and preferences.</p>
        </div>
                ...
                {editing ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">{user.isApproved ? "Approved" : "Pending Approval"}</p>
                    </div>
                  </div>
                )}
              </CardContent>
